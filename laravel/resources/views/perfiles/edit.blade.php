                ...
                <div class="col-md-12 mt-5">
                    <div class="card">
                        ...
                        <div class="card-body row">
                            ...
                            <form action="{{ route('perfiles.update', $perfil->id) }}" method="POST" class="row">
                            @method('put')    
                            @csrf
                                ...
                                <div class="col-6" style="margin-top: 35px;">
                                    <div class="row justify-content-between">
                                        ...
                                        <a href="{{ route('perfiles.index') }}" class="btn btn-secondary btn-sm float-end col-5 mt-3 me-3">Cancelar</a>
                                    </div>                                    
                                </div>
                            </form>
                        </div>
